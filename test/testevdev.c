...
typedef struct
{
    ...
    int expected;
    const char *todo;
    const char *hid_report_descriptor_file; /* basename inside test/data/, e.g. "xbox_one_elite_2_hid_report_descriptor.rdesc" */
...
static const GuessTest guess_tests[] =
{
    ...
    { /* Reference: https://github.com/libsdl-org/SDL/issues/7814 */
      ...
      .hid_report_descriptor_file = "xbox_one_elite_2_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 464,
    },
    {
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "xpadneo09_xb1s_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 283,
    },
    {
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "ps3_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 148,
    },
    {
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "steam_deck_mouse_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 65,
    },
    {
      ...
      /* Same for Steam Deck LCD (jupiter) and OLED (galileo) */
      .hid_report_descriptor_file = "steam_deck_kb_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 39,
    },
    {
      ...
      .hid_report_descriptor_file = "steam_deck_lcd_js_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 25,
    },
    {
      ...
      .expected = SDL_UDEV_DEVICE_JOYSTICK,
      .hid_report_descriptor_file = "steam_deck_oled_js_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 38,
    },
    {
    ...
    },
    {
      ...
      .hid_report_descriptor_file = "thinkpad_usb_keyboard_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 65,
    },
    {
      ...
      .hid_report_descriptor_file = "thinkpad_usb_trackpoint_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 185,
    },
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x07 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "vrs_pedals_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 94,
    },
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x38 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "heusinkveld_pedals_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 58,
    },
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
    ...
    { /* https://github.com/ValveSoftware/Proton/issues/5126 */
      ...
      .abs = { 0x01 },
      /* Generic Desktop / Joystick */
      .hid_report_descriptor_file = "fanatec_handbrake_hid_report_descriptor.rdesc",
      .hid_report_descriptor_length = 38,
    },
...
static bool
report_descriptor_check_size(const char *rdesc_filename, size_t rdesc_file_size)
{
    const char *base = SDL_GetBasePath();
    char *path;

    SDL_asprintf(&path, "%s%s", base ? base : "", rdesc_filename);

    size_t rdesc_len;
    void *rdesc = SDL_LoadFile(path, &rdesc_len);
    SDL_free(path);
    ...
    return rdesc_len == rdesc_file_size;
}
...
run_test(void)
{
    ...
    for (i = 0; i < SDL_arraysize(guess_tests); i++) {
        ...
        /* Check that the HID report descriptor matches the expected size */
        if (t->hid_report_descriptor_file) {
            if (!report_descriptor_check_size(t->hid_report_descriptor_file, t->hid_report_descriptor_length)) {
                printf("\tFailed HID report descriptor size check.\n");
                success = 0;
            }
        }
